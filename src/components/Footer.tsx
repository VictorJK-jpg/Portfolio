...
const Footer = () => {
  ...
  return (
    <footer className="bg-black text-white py-8 px-4 sm:px-6 lg:px-8 mt-auto border-t border-white"> {/* mt-auto pushes it to the bottom */}
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="flex flex-col items-center md:items-start text-center md:text-left">
          ...
          <ul className="space-y-2">
            <li><a href="mailto:victor@victorseda.xyz" className="text-gray-400 hover:text-white transition-colors duration-200">victor@victorseda.xyz</a></li>
            <li><a href="/home" className="text-gray-400 hover:text-white transition-colors duration-200">Made with 💚 In London, UK</a></li>
            {/* Social Media Links (replace with actual icons/links) */}
            <li className="flex gap-4 mt-4 justify-center md:justify-start">
              <a href="https://www.linkedin.com/in/victor-seda-41145b371/" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200">LinkedIn</a>
              {/* <a href="https://x.com/victorseda818" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-white transition-colors duration-200">Twitter</a> */}
